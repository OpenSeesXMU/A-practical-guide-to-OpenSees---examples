...
element $beamType [expr 3000] $ControlNode [expr $LsideColNodeID+$nH] $np 2 1;	
for {set i 1} {$i<$nL} {incr i} {
    element $beamType [expr 3000+$i] $ControlNode [expr $TopBeamNodeID+$i-1] $np 2 1;	
}  
element $beamType [expr 3000+$nL] $ControlNode [expr $RsideColNodeID+$nH] $np 2 1;	
...
for {set i 0} {$i<=$nH} {incr i} {
   for {set j 0} {$j<=$nL} {incr j} {
       set nodeID [expr $nodeID+1];
       node $nodeID [expr $j*$deltL] [expr $i*$deltH];
    }
}
puts "quad node built"
# tie nodes between beam,column and 2D elements
for {set i 1} {$i <= $nH} {incr i} {
    equalDOF [expr $LsideColNodeID+$i] [expr $quadNodeID+($nL+1)*$i] 1 2;
    equalDOF [expr $RsideColNodeID+$i] [expr $quadNodeID+($nL+1)*$i+$nL] 1 2;
}
for {set j 1} {$j<$nL} {incr j} {
...
recorder Element -file $data/quadStrainP1.out -time -eleRange 5001 [expr 5000+$nL*$nH] material 1 strain;
recorder Element -file $data/quadStrainP2.out -time -eleRange 5001 [expr 5000+$nL*$nH] material 2 strain;
recorder Element -file $data/quadStrainP3.out -time -eleRange 5001 [expr 5000+$nL*$nH] material 3 strain;
recorder Element -file $data/quadStrainP4.out -time -eleRange 5001 [expr 5000+$nL*$nH] material 4 strain;

recorder Element -file $data/LColS1P1.out -time -eleRange 1001 [expr 1000+$nH] section 1 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/LColS2P1.out -time -eleRange 1001 [expr 1000+$nH] section 2 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/LColS3P1.out -time -eleRange 1001 [expr 1000+$nH] section 3 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/LColS4P1.out -time -eleRange 1001 [expr 1000+$nH] section 4 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/LColS5P1.out -time -eleRange 1001 [expr 1000+$nH] section 5 fiber [expr -$cy1] [expr $cz1] strain;
                                                                           
recorder Element -file $data/LColS1P2.out -time -eleRange 1001 [expr 1000+$nH] section 1 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/LColS2P2.out -time -eleRange 1001 [expr 1000+$nH] section 2 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/LColS3P2.out -time -eleRange 1001 [expr 1000+$nH] section 3 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/LColS4P2.out -time -eleRange 1001 [expr 1000+$nH] section 4 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/LColS5P2.out -time -eleRange 1001 [expr 1000+$nH] section 5 fiber [expr $cy1] [expr $cz1] strain;

recorder Element -file $data/RColS1P1.out -time -eleRange 2001 [expr 2000+$nH] section 1 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/RColS2P1.out -time -eleRange 2001 [expr 2000+$nH] section 2 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/RColS3P1.out -time -eleRange 2001 [expr 2000+$nH] section 3 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/RColS4P1.out -time -eleRange 2001 [expr 2000+$nH] section 4 fiber [expr -$cy1] [expr $cz1] strain;
recorder Element -file $data/RColS5P1.out -time -eleRange 2001 [expr 2000+$nH] section 5 fiber [expr -$cy1] [expr $cz1] strain;
                                                                           
recorder Element -file $data/RColS1P2.out -time -eleRange 2001 [expr 2000+$nH] section 1 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/RColS2P2.out -time -eleRange 2001 [expr 2000+$nH] section 2 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/RColS3P2.out -time -eleRange 2001 [expr 2000+$nH] section 3 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/RColS4P2.out -time -eleRange 2001 [expr 2000+$nH] section 4 fiber [expr $cy1] [expr $cz1] strain;
recorder Element -file $data/RColS5P2.out -time -eleRange 2001 [expr 2000+$nH] section 5 fiber [expr $cy1] [expr $cz1] strain;
